...
public class LuaEngineCore
{
    ...
    private void InjectVitalConstants()
    {
        ...
        luaEngine.Globals["EVENT_CONTROL_CHANGED"] = 1012;
        ...
        luaEngine.Globals["EVENT_CHAINING"] = 1020;
        luaEngine.Globals["EVENT_BECOME_TARGET"] = 1022;
        luaEngine.Globals["EVENT_LEAVE_FIELD"] = 1015;
        luaEngine.Globals["EVENT_TO_GRAVE"] = 1014;
        luaEngine.Globals["EVENT_PRE_DAMAGE_CALCULATE"] = 1125;
