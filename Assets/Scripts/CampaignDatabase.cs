...
[CreateAssetMenu(fileName = "MainCampaignDB", menuName = "YuGiOh/Campaign Database")]
public class CampaignDatabase : ScriptableObject
{
    ...
    public void LoadOptimizedCampaign()
    {
        ...
        AddAct("Act 5: Pesadelo Virtual", 
            "Você está preso no ciberespaço. Os Big Five e a família Kaiba digital querem seu corpo para escapar.\n\nGozaburo é o mestre deste mundo.",
