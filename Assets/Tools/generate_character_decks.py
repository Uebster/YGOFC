...
BANLIST = {
    ...
    "0872": 0, "1268": 0, "1480": 0, "2020": 0, "0932": 0, "1251": 0,
    "0639": 0, "0363": 0, "1134": 0, "0370": 0, "1252": 0, "0485": 0,
    "0287": 0, "0321": 0, "1863": 0,
...
def generate_deck(act, difficulty_modifier, cards_by_pool, all_cards_map, dependency_map, forced_cards=None, unique_pool=None):
    ...
    # Preenche o Main Deck (Garante 40 cartas não-proibidas)
    while True:
        forbidden_count = sum(1 for cid in main_deck if BANLIST.get(cid, -1) == 0)
        target_size = 40 + forbidden_count
        
        if len(main_deck) >= target_size:
            break
